    ...
    return (
      <div className='header__wrapper__help'>
        <ul className='ul__class'>
          ...
          <li className='li__class' onClick={this.logout.bind(this, this.props.logoutUser)}><p>New project</p></li>
          <li className='li__class' onClick={this.logout.bind(this, this.props.logoutUser)}><p>New task</p></li>
